const lang = {
  ...
  it_brings_together_your_invoice_clients_and_leads:
    'Kết nối khách hàng hóa đơn và khách hàng tiềm năng của bạn',
  ...
  check_your_email_address_to_verify_your_account:
    'Kiểm tra địa chỉ email của bạn để xác minh tài khoản',
  ...
  offers_preview: 'Xem trước ưu đãi',
  ...
  password_reset_in_progress: 'Đang thực hiện đặt lại mật khẩu',
  check_your_email_address_to_reset_your_password:
    'Kiểm tra địa chỉ email của bạn để đặt lại mật khẩu',
  login: 'Đăng nhập',
  ...
  last_offer_number: 'Số ưu đãi cuối cùng',
  ...
  submit: 'Gửi',
  person: 'Cá nhân',
  people_list: 'Danh sách con người',
  firstname: 'Tên',
  lastname: 'Họ',
  ...
  sub_total: 'Tổng phụ',
  note: 'Ghi chú',
  offer_list: 'Danh sách ưu đãi',
  add_new_offer: 'Thêm ưu đãi mới',
  year: 'Năm',
  ...
  thousand_separator: 'Dấu phân cách nghìn',
  ...
  do_you_need_help_on_customize_of_this_app: 'Bạn cần trợ giúp tùy chỉnh ứng dụng này?',
  contact_us: 'Liên hệ với chúng tôi',
  customers: 'Khách hàng',
  peoples: 'Con người',
  companies: 'Công ty',
  leads: 'Khách hàng tiềm năng',
  offer_leads: 'Ưu đãi khách hàng tiềm năng',
  invoices: 'Hóa đơn',
  quotes: 'Báo giá',
  payments: 'Thanh toán',
  products: 'Sản phẩm',
